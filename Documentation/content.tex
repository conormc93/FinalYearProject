...
\paragraph{Abstract}
This paper aims to provide a technical understanding about computerized inventory management systems; the various implementations of, and the technologies used within these systems. Modern businesses can utilize the latest technologies for their warehouses to help:
\begin{itemize}
	\item analyze trends or patterns through inventory flow
	\item reduce instances where stock is too low or high, and reduce instances where there is no stock
	\item increase in accurracy and fulfillment of orders with relation to picking, packing, and shipping a customers order
	\item provide a deeper understanding of customer demand for your products
\end{itemize}
...
\paragraph{Authors}
\hfill \break Conor McGrath - B.Sc.(Hons) Computing in Software Development
\newline Aaron Healy - B.Sc.(Hons) Computing in Software Development
